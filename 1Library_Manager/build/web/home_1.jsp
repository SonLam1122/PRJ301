                        ...
                        <div class="col-md-6">
                            <div class="right-element">
                                <c:if test="${not empty sessionScope.account}">
                                    <!-- Dùng d-flex với justify-content-evenly và gap nhỏ để giảm khoảng cách -->
                                    <div class="d-flex justify-content-evenly align-items-center" style="gap: 10px;">
                                        <div class="search_icon">
                                            <a href="changepassword.jsp">
                                                <img src="images/notification-icon.png">
                                                <span class="padding_left_25">Change Password</span>
                                            </a>
                                        </div>
                                        <div class="search_icon">
                                            <a href="logout">
                                                <img src="images/eye-icon.png">
                                                <span class="padding_left_25">Logout</span>
                                            </a>
                                        </div>
                                        <div class="search_icon">
